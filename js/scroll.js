function locomotive() {
  ...
  let page2_h2 = document.querySelector('#page02>h2').textContent.split("");
  page2_h2.forEach((dets)=>{
    clutter += `<span>${dets}</span>`;
    document.querySelector('#page02>h2').innerHTML=clutter;
  })

  gsap.to("#page02>h2>span",{
    scrollTrigger:{
        trigger:"#page02>h2>span",
        start:"top bottom",
        end:"bottom top",
        scroller:"#main",
        scrub:.5,
...
//page3
function canvas(){
  const canvas = document.querySelector("#page03>canvas");
...
//.textContent --> 텍스트 콘텐츠을 가져온다
let page4_h2 = document.querySelector('#page04>h2').textContent.split("");
page4_h2.forEach((dets)=>{
  clutter2 += `<span>${dets}</span>`;
  document.querySelector('#page04>h2').innerHTML=clutter2;
})

gsap.to("#page04>h2>span",{
  scrollTrigger:{
      trigger:"#page04>h2>span",
      start:"top bottom",
      end:"bottom top",
      scroller:"#main",
      scrub:.5,
...
//page5
function canvas5(){
  const canvas = document.querySelector("#page05>canvas");
const context = canvas.getContext("2d");
...
//.textContent --> 텍스트 콘텐츠을 가져온다
let page6_h2 = document.querySelector('#page06>h2').textContent.split("");
page6_h2.forEach((dets)=>{
  clutter3 += `<span>${dets}</span>`;
  document.querySelector('#page06>h2').innerHTML=clutter3;
})

gsap.to("#page06>h2>span",{
  scrollTrigger:{
      trigger:"#page06>h2>span",
      start:"top bottom",
      end:"bottom top",
      scroller:"#main",
      scrub:.5,
...
//page7
function canvas7(){
    const canvas = document.querySelector("#page07>canvas");
  const context = canvas.getContext("2d");
  ...
  gsap.to(".page07-cir-inner",{
    scrollTrigger:{
      trigger:`.page07-cir-inner`,
      start:`top center`,
      end:`bottom 40%`,
      scroller:`#main`,
      scrub:true
...
document.querySelector("#page08 h2").textContent.split("").forEach(function(dets){
    clutter4 += `<span>${dets}</span>`

    document.querySelector("#page08 h2").innerHTML = clutter4;
})

gsap.fromTo("#page08 h2>span",{
    y:'100%',rotate:30
},{
    scrollTrigger:{
        trigger:'#page08 h2>span',
        start:'top 80%',
        end:'bottom center',
        scroller:"#main",
        scrub:5
...
gsap.fromTo('.page08-inner',{opacity:0},{
    scrollTrigger:{
        trigger:'.page08-inner',
        start:'top top',
        end:'+=50% top',
        scroller:"#main",
        scrub:1,
